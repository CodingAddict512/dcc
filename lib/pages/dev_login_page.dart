...
class DeveloperLoginPage extends StatelessWidget {
  final TextEditingController _apiKeyTextController = new TextEditingController();
  final TextEditingController _googleAppIdTextController = new TextEditingController();
  final TextEditingController _projectIdTextController = new TextEditingController();
  final TextEditingController _messagingSenderIdTextController = new TextEditingController();
          ...
          children: [
            Padding(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: "API Key",  // [DEV-Only] Don't bother with translations
                ),
              ),
            ),
            Padding(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: "Google APP ID",  // [DEV-Only] Don't bother with translations
                ),
              ),
            ),
            Padding(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: "Project ID",  // [DEV-Only] Don't bother with translations
                ),
              ),
            ),
            Padding(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: "Message Sender ID",  // [DEV-Only] Don't bother with translations
                ),
              ),
            ),
            Padding(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: "Username",  // [DEV-Only] Don't bother with translations
                ),
              ),
            ),
            Padding(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: "Password",  // [DEV-Only] Don't bother with translations
                ),
              ),
            ),
            SizedBox(
            ...
            ElevatedButton(
              ...
              onPressed: () async {
                ...
                await userCubit.devLoginWithEmailAndPassword(config, _usernameTextController.text, _passwordTextController.text);
                if (userCubit.state is UserError) {
                  FlushbarHelper.createError(message: "Login failed.", duration: Duration(seconds: 3)).show(context);
                } else {
                  navigator.pop();
                }
              },
