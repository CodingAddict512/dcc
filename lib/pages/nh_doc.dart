  ...
  Widget build(BuildContext context) {
    ...
    Widget category(Pickup pickup) {
      ...
      return BlocSubStateBuilder<FinalDispositionCubit, FinalDispositionState, FinalDispositionStateLoaded>(
        subStateBuilder: (context, state) {
          final FinalDisposition finalDisposition = state.id2disposition[pickup.finalDispositionId];
          if (finalDisposition == null) {
            // TODO: Show an error
            return loading();
          }
          final categories = NHCategory.values.map((c) => categoryBox(c, finalDisposition.category)).toList();
          return Column(
            children: [
              Text(
                localizations.translate("nhDocPageFinalDispositionCategoryLabel"),
    ...
    Widget amountOrWeight(String amount, String weight) {
      return IconTile(
        ...
        title: localizations.translate("nhDocPageAmountOrRegisteredWeightLabel"),
    ...
    Widget finalDispositionType(String type) {
      return IconTile(
        ...
        title: localizations.translate("nhDocPageFinalDispositionDescriptionLabel"),
        description: type,
      );
    }
      ...
      return Column(
        ...
        children: [
          ...
          IconTile(
            ...
            description: "${customer.streetName} ${customer.streetBuildingIdentifier ?? ''}",
          ),
          IconTile(
            icon: Icon(null),
            title: localizations.translate("nhDocPageOriginPostCodeIdentifierLabel"),
          ...
          IconTile(
            icon: Icon(null),
            title: localizations.translate("nhDocPageOriginCertificateAbNrLabel"),
    ...
    Widget transporter(Transporter transporter, Car car) {
      return Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          sectionTitle(localizations.translate("nhDocPageTransporterSectionTitle")),
          IconTile(
            icon: Icon(null),
          ...
          IconTile(
            icon: Icon(null),
            title: localizations.translate("nhDocPageTransporterPostCodeIdentifierLabel"),
            description: transporter?.postCodeIdentifier,
          ),
          IconTile(
            icon: Icon(null),
            title: localizations.translate("nhDocPageTransporterDistrictNameLabel"),
    ...
    Widget receiver(Customer customer) {
      return Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          sectionTitle(localizations.translate("nhDocPageReceiverSectionTitle")),
          IconTile(
            icon: Icon(null),
          ...
          IconTile(
            icon: Icon(null),
            title: localizations.translate("nhDocPageReceiverPostCodeIdentifierLabel"),
            description: customer.postCodeIdentifier,
          ),
          IconTile(
            icon: Icon(null),
            title: localizations.translate("nhDocPageReceiverDistrictNameLabel"),
            description: customer.districtName,
          ),
          IconTile(
            icon: Icon(null),
            title: localizations.translate("nhDocPageReceiverCertificateAbNrLabel"),
            description: customer.certificateAbNr,
          ),
        ],
      );
    ...
    Widget signature() {
      return Column(
        children: [
          ...
          IconTile(
            icon: Icon(Icons.event),
            title: localizations.translate("nhDocPageSignatureSignatureDateFieldLabel"),
            description: "", // Intentionally blank
          ),
          IconTile(
            icon: Icon(Icons.edit),
            title: localizations.translate("nhDocPageSignatureSignatureFieldLabel"),
            description: "", // Intentionally blank
          ),
        ],
      );
    ...
    Widget transporterSection() {
      return BlocSubStateBuilder<TransporterCubit, TransporterState, TransporterLoaded>(
    ...
    Widget nhDocDisplay(Pickup pickup) {
      return ListView(
        children: [
          ...
          cateogry3Extra(),
          Divider(),
          amountOrWeight(pickup.actualAmount != null ? pickup.actualAmount.toString() : pickup.amount.toString(), pickup.actualRegisteredWeight),
          finalDispositionType(pickup.actualFinalDisposition != null ? pickup.actualFinalDisposition : pickup.finalDisposition),
          Divider(),
