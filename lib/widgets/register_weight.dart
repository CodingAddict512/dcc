...
class RegisterWeight extends StatelessWidget {
  ...
  static final TextInputFormatter digitsAndDecimalOnly = FilteringTextInputFormatter.allow(RegExp(r'[0-9.]'));
  ...
  Widget build(BuildContext context) {
    ...
    StreamController<MetricType> metricStreamController = StreamController<MetricType>();
...
class AmountMetricWeight {
  ...
  AmountMetricWeight({this.amount, this.metric, this.weight});
}
