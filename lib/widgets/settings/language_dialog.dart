      ...
      content: Container(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            return ListTile(
              onTap: () => navigator.pop(DccLocalizations.supportedLocales[index]),
              title: Text(context.languageCodeToString(DccLocalizations.supportedLocales[index].languageCode)),
            );
          },
        ),
      ),
