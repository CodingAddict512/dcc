  ...
  Widget build(BuildContext context) {
    ...
    return BlocSubStateBuilder<CustomersCubit, CustomersState, CustomerStubsLoaded>(
      subStateBuilder: (context, customersLoaded) {
        return BlocSubStateBuilder<PickupEditCubit, PickupEditState, PickupEditLoaded>(
          subStateBuilder: (BuildContext context, pickupEditLoaded) {
            Customer customer = pickupEditLoaded.originCustomer;

            return CustomerSelection(
              title: customer?.name ?? DccLocalizations.of(context).translate("originCustomerSelectionEmpty"),
