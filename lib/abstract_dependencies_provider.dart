    ...
    Widget blocs({child}) {
      return MultiBlocProvider(
        providers: [
          ...
          BlocProvider(
              create: (context) => InitializationCubit.fromContext(context)),
          BlocProvider(
              create: (context) => FinalDispositionCubit.fromContext(context)),
          BlocProvider(
              create: (context) => MetricTypeCubit.fromContext(context)),
          BlocProvider(create: (context) => RoutesCubit.fromContext(context)),
          BlocProvider(create: (context) => CarCubit.fromContext(context)),
          BlocProvider(
              create: (context) => TransporterCubit.fromContext(context)),
          BlocProvider(create: (context) => CarsCubit.fromContext(context)),
          BlocProvider(create: (context) => PickupsCubit.fromContext(context)),
          BlocProvider(
              create: (context) => PickupEditCubit.fromContext(context)),
          BlocProvider(
              create: (context) => CustomersCubit.fromContext(context)),
          BlocProvider(
              create: (context) => OriginLocationsCubit.fromContext(context)),
          BlocProvider(
              create: (context) => ReceiverLocationsCubit.fromContext(context)),
          BlocProvider(create: (context) => GeoLocationCubit()),
          BlocProvider(
              create: (context) => PrimaryLocationsCubit.fromContext(context)),
          BlocProvider(
              create: (context) => ExternalNhDocCubit.fromContext(context)),
        ],
        child: child,
      );
    }
